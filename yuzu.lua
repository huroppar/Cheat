--========================================================--
--               LOCAL SCRIPT: FULL AUTO & ESP HUB       --
--========================================================--
...
local Window = Rayfield:CreateWindow({
    ...
    ConfigurationSaving = { Enabled = true, FolderName = "AutoESPHub", FileName = "Settings" },
    KeySystem = false
})
...
local function createESP(target, labelText)
    ...
    if target:FindFirstChild("ESP") then return end -- 既にあればスキップ
    local esp = Instance.new("BillboardGui")
    esp.Name = "ESP"
    esp.Adornee = target:FindFirstChild("HumanoidRootPart") or target.PrimaryPart
...
Window:CreateToggle({
    ...
    Flag = "ESPItems",
    Callback = function(value)
        settings.ESPItemsEnabled = value
    end
})
...
Window:CreateToggle({
    ...
    Flag = "ESPChests",
    Callback = function(value)
        settings.ESPChestsEnabled = value
    end
})
