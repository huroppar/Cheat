...
main.BackgroundColor3, main.BackgroundTransparency = Color3.fromRGB(20,20,20), 0.15
main.BorderSizePixel, main.Active, main.Draggable = 0, true, true

local function makeLabel(parent, text, posY, sizeX)
    local lbl = Instance.new("TextLabel", parent)
    lbl.Size = UDim2.new(0, sizeX or 200, 0, 24)
    lbl.Position = UDim2.new(0,10,0,posY)
    lbl.BackgroundTransparency = 1
    lbl.TextColor3 = Color3.new(1,1,1)
    lbl.Text, lbl.Font, lbl.TextSize = text, Enum.Font.SourceSans, 14
    return lbl
end
...
local speedLabel = makeLabel(main, "Speed: "..speedDefault, 40)
local speedToggle = Instance.new("TextButton", main)
speedToggle.Size, speedToggle.Position = UDim2.new(0,80,0,40), UDim2.new(0,220,0,40)
...
sliderFrame.Size, sliderFrame.Position = UDim2.new(0,300,0,70), UDim2.new(0,10,0,70)
sliderFrame.BackgroundColor3, sliderFrame.BorderSizePixel = Color3.fromRGB(60,60,60), 0
local sliderFill = Instance.new("Frame", sliderFrame)
sliderFill.Size, sliderFill.BackgroundColor3, sliderFill.BorderSizePixel = UDim2.new((speedDefault-speedMin)/(speedMax-speedMin),0,1,0), Color3.fromRGB(120,120,255), 0
...
jumpToggle.Size, jumpToggle.Position, jumpToggle.Text = UDim2.new(0,120,0,100), UDim2.new(0,10,0,100), "Infinite Jump: OFF"
jumpToggle.Font, jumpToggle.TextSize = Enum.Font.SourceSans, 14
...
playersTitle.BackgroundTransparency, playersTitle.Text = 1, "Players"
playersTitle.TextColor3, playersTitle.TextSize, playersTitle.Font = Color3.new(1,1,1),16,Enum.Font.SourceSansBold
...
Players.PlayerRemoving:Connect(function(pl)
    refreshPlayerList()
    if selectedPlayer == pl then selectedPlayer, followEnabled, followTarget = nil, false, nil followBtn.Text="Follow Selected: OFF" end
end)
...
sliderFrame.InputBegan:Connect(function(inp)
    if inp.UserInputType==Enum.UserInputType.MouseButton1 or inp.UserInputType==Enum.UserInputType.Touch then
        setSliderFromX(inp.Position.X - sliderFrame.AbsolutePosition.X)
        dragging=true
    end
end)
